...
document.addEventListener("DOMContentLoaded", () => {
    ...
    datosCuriososLink.addEventListener("click", async (e) => {
        ...
        try {
            const res = await fetch("/Capa/Public/php/api.php?endpoint=datos-curiosos");
            const data = await res.json();
    ...
    if (navPublicaciones) {
        navPublicaciones.addEventListener("click", async (e) => {
            e.preventDefault();
            publicacionesLink.click(); // reutiliza la misma función que escritorio
        });
    }

    if (navDatosCuriosos) {
        navDatosCuriosos.addEventListener("click", async (e) => {
            e.preventDefault();
            datosCuriososLink.click(); // reutiliza la misma función que escritorio
        });
    }
    ...
    if (navCrear) {
        navCrear.addEventListener("click", (e) => {
            e.preventDefault();
            createPostBtn.click(); // Reutiliza la misma acción que el botón de escritorio
        });
    }
